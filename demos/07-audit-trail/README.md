...
This demo shows policy audit logging. A simple program runs with several capability requests - some allowed, some denied - and every decision is written to a JSONL audit log file.
