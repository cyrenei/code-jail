...
This demo shows the behavioral drift detector. The declared intent is "read and analyze" but the requested capabilities include a writable volume mount. The arbiter flags this mismatch as drift - the agent is asking for write access while claiming it only wants to read.
