...
Tests compile Rust fixtures to WASM and run them through the cask binary. The wasm32-wasip1 target must be installed or tests will fail.
...
- Container state is JSON files in ~/.cask/containers/. Keep it simple.
...
src/
  ...
  capability.rs    Caskfile parsing, capability types, resolution.
